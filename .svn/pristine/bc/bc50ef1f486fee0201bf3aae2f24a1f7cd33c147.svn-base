...
public:
	...
	Node(const T& dataValue, Node<T> *nextNode = nullptr) : data(dataValue), next(nextNode) {};
};
...
public:
    ...
    stack<T>& operator= (stack<T>);		   // Overloaded assignment
...
bool stack<T>::full() const {
	Node<T> *temp = new(std::nothrow) Node<T>(T());
